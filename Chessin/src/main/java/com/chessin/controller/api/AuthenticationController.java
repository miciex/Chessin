...
public class AuthenticationController {
    ...
    public ResponseEntity<?> register(@RequestBody RegisterRequest request){
        ...
        if(repository.existsByEmail(request.getEmail())){
            return ResponseEntity.badRequest().body(ResponseMessage.of("Email already exists in the database."));
        }
    ...
    public ResponseEntity<?> authenticate(@RequestBody AuthenticationRequest request){
        ...
        if(!repository.existsByEmail(request.getEmail())){
            return ResponseEntity.badRequest().body(ResponseMessage.of("Email does not exist in the database."));
        }
    ...
    public ResponseEntity<?> verifyCode(@RequestBody CodeVerificationRequest request){
        ...
        return switch (request.getVerificationType()) {
            ...
            default -> ResponseEntity.badRequest().body(ResponseMessage.of("Invalid verification type."));
        };
    }
    ...
    public ResponseEntity<?> twoFactorAuthenticationEnabled(@RequestBody TwoFactorAuthenticationEnabledRequest request){
        ...
        return repository.findByEmail(request.getEmail()).get().isTwoFactorAuthenticationEnabled()
                ? ResponseEntity.ok().body(ResponseMessage.of("True")) : ResponseEntity.ok().body(ResponseMessage.of("False"));
    }
