...
export const moveFactory = ({
  ...
  const takenP = move
    ? move.movedPiece
    : pieces
    ? calcTakenPiece(pieces, startF, endF, movedP)
    : 0;
  ...
  return {
    ...
    movedPiece: movedP,
    takenPiece: takenP,
    takenPieceField: move
      ? move.takenPieceField
      : pieces
      ? calcTakenPieceField(pieces, startF, endF, movedP, takenP)
      : -1,
